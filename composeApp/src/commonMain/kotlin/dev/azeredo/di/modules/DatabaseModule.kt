...
import dev.azeredo.data.productimage.ProductImageRepositoryImpl
...
val RepositoryModule = module {
    ...
    single<StockMovementRepository> { StockMovementRepositoryImpl(get(), get()) }
    single<ProductImageRepository> { ProductImageRepositoryImpl(get()) }
}
...
val DaoModule = module {
    ...
    single<ProductImageDao> { get<AppDatabase>().getProductImageDao() }
}